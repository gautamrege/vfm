...
/* For IB  */
vfm_init_info_packet init_info_pack;
...
main(int argc, char* argv[])
{
        ...
        if (g_vfm_remote == 1 && g_vfm_protocol == VFM_EN_PROTOCOL) {
        ...
        else if (g_vfm_local == 1 && g_vfm_protocol == VFM_IB_PROTOCOL) {
#ifdef VFM_EOIB
