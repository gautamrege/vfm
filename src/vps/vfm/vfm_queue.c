...
vfm_task *first_task = NULL; /*Locate the first task in queue*/
vfm_task *last_task  = NULL; /*Locate the last task in queue*/
 ...
 * [IN] vfm_type   : VFM type - LBC or RBC
 *
 * Return : err
 *
 */
                                                     ...
                                                     uint8_t vfm_type)
{
        ...
        new_task = (vfm_task *)malloc(sizeof(vfm_task));
