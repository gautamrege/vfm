...
/* Queue key */
#define QK_VFM_DISCOVERY      0x80020000
#define QK_BRIDGEX_DISCOVERY  0x80020000
#define QK_EOIB               0x80020002
#define QK_FCOIB              0x80020004

/* Management base version */
#define VFM_MGMT_BASE_VERSION  0x01


/* Management classes */
#define VFM_MGMT_SUBN_ADM_CLASS 0x03

/* Management methods */
#define VFM_MGMT_GET_METHOD             0x01
#define VFM_MGMT_SUBN_ADM_METHOD_SET    0x02
#define VFM_MGMT_SUBN_ADM_METHOD_DELETE 0x015
...
typedef struct __vfm_rmpp_packet {
       vfm_mad_hdr  mad_hdr;
       vfm_rmpp_hdr rmpp_hdr;
       uint8_t *data;
}vfm_mad_packet;

/* MCMemberrecord */
typedef struct __vfm_mcmemeber_record {
...
}vfm_mcmemeber_record;


/* SA_MAD packet structure */
typedef struct __vfm_sa_mad_packet {
        vfm_mad_hdr  mad_hdr;
        vfm_rmpp_hdr rmpp_hdr;
        vfm_sa_hdr   sa_hdr;
        uint8_t data[200];
