...
def vadapter_edit():
        result = bxm.py_bxm_vadapter_edit_general_attr(
                                        {'io_module_id' : io_module_id,
                                        'vfabric_id' : vfabric_id,
                                        'id' : vadapter_id})
def vfabric_create():
        result = bxm.py_bxm_vfabric_create({'protocol' : 1,
                                                'name' : "V Fabric10",
                                                'desc' : "test",
                                                'type' : 1})
def vfabric_edit():
        result = bxm.py_bxm_vfabric_edit_general_attr({
...
def vfabric_online():
        result = bxm.py_bxm_vfabric_online({'id' : vfabric_id})
